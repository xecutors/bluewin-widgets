...
var _getDisplayName = __webpack_require__(30);
...
var _setStatic = __webpack_require__(31);
...
var BluewinWidgetFactory = function () {
  ...
  _createClass(BluewinWidgetFactory, [{
    key: 'render',
    value: function render(element, Component, aProps, callback) {
      _reactDom2.default.render(_react2.default.createElement(Component, _extends({ url: this.endpoint }, aProps)), element, callback);
    }
  }]);

  return BluewinWidgetFactory;
}();

exports.default = BluewinWidgetFactory;
...
exports.Loading = exports.NewsLight = exports.NewsClassic = undefined;

var _withProps = __webpack_require__(29);
...
var NewsClassic = (0, _withProps2.default)(function () {
  return { isClassic: true };
})(_News2.default);
var NewsLight = (0, _withProps2.default)(function () {
  return { isClassic: false };
})(_News2.default);

exports.NewsClassic = NewsClassic;
exports.NewsLight = NewsLight;
...
var _wrapDisplayName = __webpack_require__(12);

var _wrapDisplayName2 = _interopRequireDefault(_wrapDisplayName);

var _setDisplayName = __webpack_require__(13);

var _setDisplayName2 = _interopRequireDefault(_setDisplayName);

var _mapProps = __webpack_require__(32);
...
var _isomorphicUnfetch = __webpack_require__(34);
...
var getFeed = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, limit) {
    var results, jsonData, filteredResults;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            filteredResults = jsonData.json.filter(function (_ref2) {
              var type = _ref2.type;
              return type === 'teaser';
            }).map(function (_ref3) {
              var json = _ref3.json;
  ...
  return function getFeed(_x, _x2) {
...
var News = function (_React$Component) {
  ...
  function News(props) {
    ...
    getFeed(props.url, props.isClassic ? 5 : 3).then(function (result) {
        ...
        loading ? _react2.default.createElement(_Loading2.default, null) : news.map(function (entry) {
          return _react2.default.createElement(
            ...
            entry.flag && _react2.default.createElement(
              'span',
              { className: 'flag flag-color-' + entry.flag.color },
              entry.flag.text
            ),
            _react2.default.createElement('img', { src: entry.image, alt: entry.title }),
            entry.supertitle,
            entry.title
          );
        })
...
module.exports = window.fetch || (window.fetch = __webpack_require__(14).default || __webpack_require__(14));
...
exports.WrappedLoading = undefined;
...
var WrappedLoading = function WrappedLoading(_ref) {
  var props = _objectWithoutProperties(_ref, []);

  return _react2.default.createElement(
    "div",
    { className: "loader-wrap" },
    _react2.default.createElement(Loading, props)
  );
};

exports.WrappedLoading = WrappedLoading;
exports.default = Loading;

/***/ })
/******/ ]);
//# sourceMappingURL=bluewin-widgets.js.map